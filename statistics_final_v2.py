...
def create_stats (graphName, H):
    ...
    ##          0.       Nber of green nodes + a set of names of all green nodes
    nberGN = len(H.nodes())
    #print ("(create_stats) Nber of green nodes: ", nberGN )


    ##          1.       Nber of connected components (cc)
    #print
    ...
    ##          3.       Nber of cc of size 1: only one node
    nberOneNodeCC = 0
    for i in listCC:
        if len(i)== 1:
            nberOneNodeCC = nberOneNodeCC +1
    ...
    ##print ("(create_stats) 5. Nber of edges in induced green subgraph :" , nbrEdgesGreen)



    ##          6.       Graph(highestCC) density
    #print
    density = float (nberEdgesLargestCC) / float(len(largestCC))
    ##density = nberEdgesLargestCC/(len(largestCC) -1)
    ##print ("(create_stats) 5. Nber of edges in induced green subgraph :" , nbrEdgesGreen)
